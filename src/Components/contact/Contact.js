      ...
      <div className="container contact_container">
        <div className="contact_options">
          ...
          <article className="contact_option">
            ...
            <a href="https://www.linkedin.com/in/abhijeet-rawte-1a962216b/" target="_blank" rel="noopener noreferrer">
              Connect with Me
            </a>
          </article>
          <article className="contact_option">
            ...
            <h4>Whatsapp</h4>
            {/* <h5>+91 8962663656</h5> */}
            <a href="http://wa.me/+917000558946">Ping me</a>
          </article>
        </div>
